...
1. Add a change event listener to the HTML element with an ID of sortBy that calls the sortBy function and sends a arrow function result with the templeList as the argument.
