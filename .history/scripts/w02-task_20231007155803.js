...
let elements = favoriteFood.length;
favoriteFood.map( (item, index)=>{  
    index < elements-1 ? foodElement.innerHTML +=`${item}, `: foodElement.innerHTML += `${item}.<br>`;   
   });
favoriteFood.push(anotherFavoriteFood);
favoriteFood.map( (item, index)=>{ 
index < elements ? foodElement.innerHTML +=`${item},`: foodElement.innerHTML +=` ${item}.<br>`;       
});
...
array.pop();
array.map( (item, index)=>{ 
index < elements-2 ? foodElement.innerHTML +=`${item}</em>, `: foodElement.innerHTML +=` ${item}.<br>`;   
});
