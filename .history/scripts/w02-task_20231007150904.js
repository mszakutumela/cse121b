...
let imageElement = document.query('img');
...
imageElement[0].setAttribute('scr', `${profilePicture}`);
imageElement[0].setAttribute('alt', `${profilePicture}`);
imageElement[0].setAttribute('title', `${profilePicture}`);
