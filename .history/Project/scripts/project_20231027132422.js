...
function ansCondition() {
    condition1 = document.getElementById('answers');
    condition2 = document.querySelector('#answers').addEventListener('click', () => ansCondition(),);
    if (condition =! addTemples()) {
        mouseClick = 0
...
document.querySelector('#answers').addEventListener('click', () => ansCondition(),);
