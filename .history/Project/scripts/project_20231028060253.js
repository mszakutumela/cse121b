...
const displayTemples = (temples) => {
    ...
    let heading = "MILESTONES";
    let announced = document.createElement("h4");
    let groundbreaking = document.createElement("h4");
    let dedicated = document.createElement("h4");
    templeName.textContent = temple.templeName;
    heading.textContent = temple.heading;
    ...
    article.appendChild(announced);
    article.appendChild(groundbreaking);
